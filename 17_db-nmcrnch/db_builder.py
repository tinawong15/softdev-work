...
def peeps():
    ...
    for record in recordList:
        c.execute("INSERT INTO peeps VALUES ( \"{}\" , \"{}\" , \"{}\" )".format(record['name'] , record['age'] , record['id']) ) #run SQL statement
...
def courses():
    ...
    for record in recordList:
        c.execute("INSERT INTO courses VALUES ( \"{}\" , \"{}\" , \"{}\" )".format(record['code'] , record['mark'] , record['id']) ) #run SQL statement
